<template>
    <div id="wrapper">
        ...
        <div class="sidebar" :class="{ showOverlay: overlayVisibility }">
            ...
            <div class="side-links">
                <ul>
                    ...
                    <li v-if="!loggedIn"><router-link @click="hideOverlay" :to="{ name: 'Register' }">Register</router-link>
                    </li>
                    <li v-if="!loggedIn"><router-link @click="hideOverlay" :to="{ name: 'Login' }">Login</router-link></li>
                    <li v-if="loggedIn"><router-link @click="hideOverlay"
        ...
        <main class="container">
            <!-- render components depending on the vite page visited -->
